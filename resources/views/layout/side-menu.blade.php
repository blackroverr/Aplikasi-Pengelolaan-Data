...
@section('content')
    ...
    <div class="flex">
        <!-- BEGIN: Side Menu -->
        <nav class="side-nav">
            <a href="dashboard-page" class="intro-x flex items-center pl-5 pt-4">
                <img alt="" class="" src="{{ asset('dist/images/spd_logo.png') }}" width="140" height="100">
            ...
            <ul>
                <li class="side-nav__devider my-6"></li>
                    ...
                    @endforeach
                        <li>
                            <a href="/users-page"  class="'side-menu side-menu--active' {{ $second_level_active_index == $menuKey ?  : 'side-menu' }}">
                                <div class="side-menu__icon">
